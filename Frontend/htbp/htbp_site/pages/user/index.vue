<template>
  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      ...
      <div class="nav-item">
        <span class="v-link clickable dark"> UpdateUserInformation </span>
      </div>
      <div class="nav-item">
...
export default {
  data() {
    return {
      ...
      //fileUrl:'http://localhost/api/oss/file/fileUpload', //localhost is gateway?
      fileUrl: "http://192.168.1.10:8080/api/oss/file/fileUpload", //point to gateway
      userInfo: {
        param: {},
      },
      submitBnt: "提交",
